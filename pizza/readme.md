# Pizzan verkkosivusto (vain asiakkaille)

Toteutettu Asiakas-roolille määrittelydokumentin pohjalta.

## User stories → Toteutus

1. **Haluan nähdä nopeasti pizzamenun kuvineen, kuvauksineen ja hintoineen, jotta voin valita sopivan pizzan.**  
   - Seksio `<section id="menu">` tiedostossa `index.html` (pizzalista kuvilla, kuvauksilla ja hinnoilla)
